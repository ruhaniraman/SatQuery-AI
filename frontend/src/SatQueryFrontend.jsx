...
const SatQueryFrontend = () => {
  ...
  useEffect(() => {
    ...
    if (!document.getElementById(linkId)) {
      ...
      link.id = linkId;
      link.rel = 'stylesheet';
      link.href = 'https://fonts.googleapis.com/css2?family=Outfit:wght@800;900&family=Inter:wght@500;600&display=swap';
    ...
    const initMap = async () => {
      try {
        ...
        const map3D = new Map3DElement({
          ...
          tilt: 105,
          heading: 0,
          defaultUIHidden: true, // Cleanly hides the native navigation and compass controls
        });
  ...
  return (
    <div style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden', backgroundColor: '#030712' }}>
      ...
      {/* Background 3D Globe Container - Fully unblocked */}
      <div 
        ref={mapContainerRef} 
